"""Main FastAPI entry point for the sentiment analysis API."""
...
app = FastAPI(
    ...
    description=(
        "REST API for classifying text sentiment with a HuggingFace transformer, "
        "plus batch inference, caching, and rate limiting."
    ),
    lifespan=lifespan,
)
